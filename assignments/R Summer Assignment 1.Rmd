...
1.  **Preparation**: Before completing each RMarkdown on this summer assignment,
...
-   **WATCH**:
    ...
    -   [Lists](https://vimeo.com/220490360)
...
2.  **Submission**: Complete your assignment in the Posit Cloud environment.
    ...
    [this Assignment
    link](https://www.dropbox.com/request/dcWEAIkBUzBmX597wock). Change line 3
    of this file to your name. We will announce when the Canvas site is created.
...
**Please save often.** Please save a **permanent copy.** You do this only the
first time you open the Posit Project. This will be saved in your Workspace so
you can access it at any time. Remember to save your work frequently. In Posit
Cloud,you can save your RMarkdown by going to File → Save, or with CMD + S (Mac)
/ Ctrl + S (PC).

If you get stuck in any aspect of using these RMarkdown, please use Slack to ask
the teaching team.
