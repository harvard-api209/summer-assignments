...
1.  **Preparation**: If you are new to R, we strongly recommend waching the
    videos below.
2.  Before completing each RMarkdown on this summer assignment, we will ask you
    to please watch a brief primer from the creators of RStudio, an application
    for interacting with R that we will use later in the summer. We recommend
    watching this video first, taking notes in the code box below, and coming
    back later to complete the rest of the exercises.
