...
**Using AI while learning R:** In this capstone, AI tools may help you debug an
error or explain unfamiliar syntax. They should not choose your question, write
your interpretation, or replace your own checks. You will be asked to document
any AI help you used and how you verified it.

# ***Part I - Analysis of World Economic Outlook Data***

## **Problem 1: Sorting by Values**

The following questions are based on a fixed teaching version of the World
Economic Outlook (WEO) dataset published by the International Monetary Fund
(IMF). We use a fixed version so everyone can reproduce the same results. Each
...
The function `select()` keeps only the columns you name. For example,
`weo |> select(country, continent)` would keep just those two columns.
...
Here is a small example of how `is.na()` works. It returns `TRUE` for missing
...
Please also write a short analysis memo here:

-   **Question:** What did you ask?
-   **Data:** What does one row represent, and which variables did you use?
-   **Approach:** What code steps did you use?
-   **Finding:** What is your main takeaway?
-   **Caveat:** What is one limitation or reason to be cautious?

A complete memo should be short but specific. A reader should be able to tell
what you studied, what code steps you used, what you found, and why your finding
should be interpreted with care.

Write your memo here:

If you used AI for this capstone, briefly document it here. What did you ask it
for, what did it suggest, and how did you verify the suggestion? If you did not
use AI, write "I did not use AI for this capstone."

Write your AI-use note here:

## **[Optional Challenge Problem] More Graphing**

This optional problem is more challenging. It involves some commands not covered
in the primers. Attempt it if you have time and want extra graphing practice,
but do not get discouraged if you get stuck.
...
The `ggrepel` package helps add labels that avoid overlapping points. The
`scales` package helps format axes, such as using commas or dollar signs. Use
these tools only if they help make your figure easier to read.
...
-   Combine sorting, filtering, mutating, graphing, and summarizing in one
    analysis.
-   Use `select()`, `is.na()`, and `na.rm` in context.
-   Create and interpret GDP per capita measures.
-   Write a short analysis memo with a clear question, approach, finding, and
    caveat.
-   Document and verify any AI assistance you used.

## Before you submit

-   Knit the notebook successfully.
-   Answer every written question in your own words.
-   Complete the short analysis memo.
...
throughout the semester. We believe the above primers and exercises provide a
...
This [course](https://www.coursera.org/learn/data-analysis-with-r) provides
additional introductory instruction to R. You do not need to do it all to get
