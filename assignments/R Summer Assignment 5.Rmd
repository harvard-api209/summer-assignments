...
2.  **Submission**: Complete your assignment in the Posit Cloud environment.
    ...
    [this Assignment
    Link](https://www.dropbox.com/request/DlVlonnaIag3fAgZYVJi). Remember to add
...
If you get stuck in any aspect of using these RMarkdowns, please use Slack to
ask the teaching team.
...
Visualization](https://r4ds.hadley.nz/data-visualize.html) 2. [Chapter 5 - Data
