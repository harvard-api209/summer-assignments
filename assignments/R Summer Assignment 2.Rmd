...
# If you are running this code on your local machine and you run into an error regarding trying to use CRAN without setting a mirror, the uncomment the following line of code, which may be needed in each of your subsequent workbooks:
