...
2.  **Preparation**: Like the first RMarkdown, we ask you to follow this RStudio
    tutorial before starting this RMarkdown. We strongly recommend taking notes
...
3.  **Submission**: Complete your assignment in the Posit Cloud environment.
    ...
    [this Assignment
    Link](https://www.dropbox.com/request/O9oNSgf3KLVggkdHQZE2). Remember to add
...
step. However, make sure you whether or not you would like to overwrite your
object. Sometimes it might be better just to save your data manipulation into a
new object.
