---
title: "R Summer Assignment -- Part 3 (Solutions)"
author: "YOUR NAME"
...
Displaying the same information, but which you think is more effective is
debatable!
...
ma |>
  ...
  ggplot(aes(x = year, y = democrat, fill = winner, shape = modern)) + 
    geom_point()
```
...
ok_plot + 
  theme_bw() + 
  labs(
    title = "Oklahoma population since 1960",
    x = "Year", 
    y = "Population"
  )
```
...
# Write your code here.
pop |>
  filter(region == "Midwest" & year > 1950 & year < 2020) |>
  ggplot(
    aes(
      x = year, 
      y = population
